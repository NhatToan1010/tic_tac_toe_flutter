...
class GameController extends GetxController {
  ...
  void _togglePlayer() {
    GameMechanism.togglePlayer(currentPlayer.value);
  }

  void _checkWin() {
    gameResult.value = GameMechanism.checkIfWinnerFound(boardGame);
    switch (currentPlayer.value) {
      case GameMechanism.player1: player1Win++; break;
      case GameMechanism.player2: player2Win++; break;
      case GameMechanism.DRAW: draw++; break;
      default: break;
    }
  }
  ...
  String? getCurrentPlayerMove() {
    if (gameResult.value != GameMechanism.NOT_WINNER_YET){
